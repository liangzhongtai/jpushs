...
-(void)applicationDidLaunch:(NSNotification *)notification{
    ...
    [JPUSHService registrationIDCompletionHandler:^(int resCode, NSString *registrationID) {
      ...
      [ud setValue:registrationID forKey:JPUSH_ID];
      [ud synchronize];
...
-(BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *) launchOptions{
    ...
    BOOL bl = [super application:application didFinishLaunchingWithOptions:launchOptions];
...
-(void)networkDidReceiveMessage:(NSNotification *)notification {
    NSLog(@"检查推送设置。。。。。。");
    [[NSJPushUtil new] checkSetting:notification];
}



-(void)jpushNotificationCenter:(UNUserNotificationCenter *)center willPresentNotification:(UNNotification *)notification withCompletionHandler:(void (^)(NSInteger))completionHandler{
    NSLog(@"app，jpushNotificationCenter willPresentNotification");
  ...
  if ([notification.request.trigger isKindOfClass:[UNPushNotificationTrigger class]]) {
    ...
    userInfo[@"identifier"]        = notification.request.identifier;
      NSLog(@"自定义消息content.extras:%@",content.userInfo);
  }
...
- (void)application:(UIApplication *)application didReceiveLocalNotification:(UILocalNotification *)notification {
  NSLog(@"app，application didReceiveLocalNotification");
  NSMutableDictionary *localNotificationEvent = @{}.mutableCopy;
