...
@property(nonatomic,assign)NSInteger jpushType;
...
-(void)setSetting:(CDVInvokedUrlCommand *)command{
    //command.callbackId;
    self.jpushType = [command.arguments[0] integerValue];
    if(self.jpushType == SET_SETTING){
        NSUserDefaults *ud = [NSUserDefaults standardUserDefaults];
        NSDictionary *dic = command.arguments[1];
        [ud setBool:[dic objectForKey:USE_PUSH] forKey:USE_PUSH];
        [ud setBool:[dic objectForKey:SOUND] forKey:SOUND];
        [ud setBool:[dic objectForKey:SHAKE] forKey:SHAKE];
        [ud setInteger:[[dic objectForKey:S_SHOWWEEK] integerValue] forKey:S_SHOWWEEK];
        [ud setInteger:[[dic objectForKey:E_SHOWWEEK] integerValue] forKey:E_SHOWWEEK];
        [ud setInteger:[[dic objectForKey:S_SHOWTIME] integerValue] forKey:S_SHOWTIME];
        [ud setInteger:[[dic objectForKey:E_SHOWTIME] integerValue] forKey:E_SHOWTIME];
        [ud setInteger:[[dic objectForKey:FREQUENCY] integerValue] forKey:FREQUENCY];
        
        [ud synchronize];
    }else if(self.jpushType == GET_SETTING){
        NSUserDefaults *ud = [NSUserDefaults standardUserDefaults];
        NSMutableDictionary *dic = [NSMutableDictionary new];
        [dic setValue:[ud valueForKey:USE_PUSH] forKey:USE_PUSH];
        [dic setValue:[ud valueForKey:SOUND] forKey:SOUND];
        [dic setValue:[ud valueForKey:SHAKE] forKey:SHAKE];
        [dic setValue:[ud valueForKey:S_SHOWWEEK] forKey:S_SHOWWEEK];
        [dic setValue:[ud valueForKey:E_SHOWWEEK] forKey:E_SHOWWEEK];
        [dic setValue:[ud valueForKey:S_SHOWTIME] forKey:S_SHOWTIME];
        [dic setValue:[ud valueForKey:E_SHOWTIME] forKey:E_SHOWTIME];
        [ud setInteger:[[dic objectForKey:FREQUENCY] integerValue] forKey:FREQUENCY];
