...
//照相机
static NSInteger const GET_SETTING = 0;
static NSInteger const SET_SETTING = 1;


static NSString *const USE_PUSH   = @"usePush";
static NSString *const SOUND      = @"sound";
static NSString *const SHAKE      = @"shake";
static NSString *const S_SHOWWEEK = @"sWeek";
static NSString *const E_SHOWWEEK = @"eWeek";
static NSString *const S_SHOWTIME = @"sTime";
static NSString *const E_SHOWTIME = @"eTime";
static NSString *const FREQUENCY  = @"frequency";
static NSString *const JPUSH_ID   = @"jpush_id";
static NSString *const LAST_NOT_TIME = @"last_not_time";
