...
// JPushPlugin.prototype = window.JPush
...
// Common methods
// JPushPlugin.prototype.init() = window.JPush.init();
// this.callNative("initial", [], null) = cordova.exec(null, null, "JPushPlugin", "initial", []);
...
//添加公共函数
JPushPlugin.prototype.setting = function(setting) {
  if (this.isPlatformIOS()) {
    this.callNative("setting", [setting], null);
  } else {
    this.callNative("setting", [setting], null);
  }
};
...
//js端监听回调 document.addEventListener("jpush.receiveRegistrationId", function (event) {}, false)
//window.plugins.jPushPlugin = new JPushPlugin()
//window.plugins.jPushPlugin.receiveMessageInAndroidCallback(data) = JPushPlugin.prototype.receiveRegistrationIdInAndroidCallback(data)
